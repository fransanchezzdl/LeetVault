...
export function Sidebar() {
  ...
  return (
    <aside className="relative flex w-56 flex-shrink-0 flex-col gap-2 overflow-hidden rounded-2xl bg-[var(--sidebar-bg)] p-4 shadow-[var(--shadow-panel)] ring-1 ring-inset ring-fg/10 backdrop-blur-[28px] backdrop-saturate-[180%]">
